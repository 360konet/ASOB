...
@media print {
  ...
  #simpletable th, #simpletable td {
   ...
   <script>
function printTable() {
  var textToPrint = "Confidential Report.";
  
  // Open the print window with the custom text and table
  var printWindow = window.open('', '_blank');
  printWindow.document.write('<html><head><title>ASOB</title></head><body>');
  printWindow.document.write('<div style="text-align: center;">'); 
  printWindow.document.write('<p style="margin-top: -1px;">'+'Restricted'+'</p>');
  printWindow.document.write('</div>');
  printWindow.document.write('<div style="text-align: center;">'); 
  printWindow.document.write('<div style="display: flex; justify-content: space-between;">');
  printWindow.document.write('<img src="armylogo.png" width="50px" height="50px" alt="Army Logo">');
  printWindow.document.write('<img src="asob.png" width="50px" height="50px" alt="ASOB Logo">');
  printWindow.document.write('</div>');
  printWindow.document.write('<div style="text-align: center;">'); 
  printWindow.document.write('<p>'+'Confidential Report'+'</p>');
  printWindow.document.write('</div>');
  printWindow.document.write(document.getElementById('simpletable').outerHTML);
  printWindow.document.write('<div style="position: absolute; bottom: -10px; text-align: center; width: 100%;">'); 
  printWindow.document.write('<p>'+'Restricted'+'</p>');
  printWindow.document.write('</div>');
