                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="#!">Edit Attachment</a></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <form method="POST" action="{{url('/update-attach/'.$attach->id)}}" enctype="multipart/form-data">
                                    @csrf
                            ...
                            <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="personnel_id" readonly id="select-field-2" class="mb-3 form-control" required>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <label for="exampleInputPassword1">Return Date<b style="color:red;">*</b></label>
                                 <input type="date" class="form-control" name="arrival_date" value="{{$attach->arrival_date}}" placeholder="Select expected return date" required>                                
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="custom-file">
                                    <a href="{{url('/attachments')}}">Cancel</a>
                                    </div>
                                    <div class="input-group-append">
                                    <button class="btn  btn-primary" style="float:right;" type="submit" value="submit">Update</button>
                                    </div>
                                </div>
                            </form>
                            </div>
