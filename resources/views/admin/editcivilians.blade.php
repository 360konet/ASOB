                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <div class="page-header-title">
                            <h5 class="m-b-10">Update Deference Civilian</h5>
                        </div>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="#"><i class="feather icon-home"></i></a></li>
                            <li class="breadcrumb-item"><a href="{{url('/civilians-portal')}}">Civilians</a></li>
                            <li class="breadcrumb-item"><a href="#!">Update Deference Civilian</a></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                 <form method="POST" action="{{url('/civilianedit/'.$editcivilians->id)}}" enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT')
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Rank<b style="color:red;">*</b></label>
                                        <select class="mb-3 form-control" name="rank" required>
                                        <option value="{{$editcivilians->rank}}">{{$editcivilians->rank}}</option>
                                        <option>--Change Rank--</option>
                                        <option value="Junior Staff">Junior Staff</option>
                                        <option value="Senior Staff">Senior Staff</option>                                        
                                        </select>
                                    </div>
                                    @if($editcivilians->image)
                                    <img src="{{asset('civilians/'.$editcivilians->image)}}" style="border-radius: 100px;" name="image" height="150px" width="150px">
                                    @endif
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="fname" value="{{$editcivilians->fname}}" class="form-control" placeholder="Enter first name" required>
                                    </div>
                            </div>
                            <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Service Number<b style="color:red;">*</b></label>
                                        <input type="text" value="{{$editcivilians->service}}" name="service" class="form-control" placeholder="Enter service number" required>
                                    </div>
                                    <div class="form-group">
                                        <label>Gender<b style="color:red;">*</b></label>
                                    <select class="mb-3 form-control" name="arm" required>
                                        <option value="{{$editcivilians->Gender}}">{{$editcivilians->arm}}</option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="{{$editcivilians->lname}}" name="lname" class="form-control" placeholder="Enter last name" required>
                                    </div>                                    
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <label for="exampleInputPassword1">Nationality<b style="color:red;">*</b></label>
                                 <input type="text" class="form-control" value="{{$editcivilians->nationality}}" name="nationality" placeholder="Enter nationality" required>                                    
                            </div>
                            <div class="col-md-6">
                                <label for="exampleInputPassword1">Hometown<b style="color:red;">*</b></label>
                                 <input type="text" class="form-control" value="{{$editcivilians->hometown}}" name="hometown" placeholder="Enter hometown" required>                                    
                            </div>
                            <div class="col-md-6">
                                <label for="exampleInputPassword1">Date Of Birth (DoB)<b style="color:red;">*</b></label>
                                 <input type="date" class="form-control" name="dob" value="{{$editcivilians->dob}}" placeholder="Select date" required>                                    
                            </div>
                            <div class="col-md-6">
                                <label for="exampleInputPassword1">Blood Type<b style="color:red;">*</b></label>
                                <select class="mb-3 form-control" name="blood" required>
                                    <option value="{{$editcivilians->blood}}">{{$editcivilians->blood}}</option>
                                    <option>--Change Blood Type</option>
                            ...
                            <div class="col-md-6">
                                <label for="exampleInputPassword1">Region<b style="color:red;">*</b></label>
                                 <input type="text" name="region" value="{{$editcivilians->region}}" class="form-control" placeholder="Enter region" required>                                    
                            </div>
                        </div>
                        <hr>
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <label for="exampleInputPassword1">UN Operations</label>
                                     <textarea type="text" name="un" value="{{$editcivilians->un}}" class="form-control" placeholder="Enter un operations"></textarea>                                    
                                </div>
                            </div>
                            <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <label for="exampleInputPassword1">Courses</label>
                                     <textarea type="text" name="military" value="{{$editcivilians->military}}" class="form-control" placeholder="Enter course"></textarea>                                    
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <label for="exampleInputPassword1">Spouse Name (leave empty if not married)</label>
                                 <input type="text" name="spouse" value="{{$editcivilians->spouse}}" class="form-control" placeholder="Enter spouse name">                                    
                            </div>
                            <div class="col-md-6">
                                <label for="exampleInputPassword1">Next Of Kin<b style="color:red;">*</b></label>
                                 <input type="text" name="kin" class="form-control" value="{{$editcivilians->kin}}" placeholder="Enter next of kin" required>                                    
                            </div>
                            <div class="col-md-6">
                                <label for="exampleInputPassword1">Spouse Phone Number(leave empty if not married)</label>
                                <input type="text" name="sphone" class="form-control" value="{{$editcivilians->sphone}}" placeholder="Enter spouse name" onkeypress="return isNumberKey(event)">                                    
                            </div>
                            <div class="col-md-6">
                                <label for="exampleInputPassword1">Kin Relation<b style="color:red;">*</b></label>
                                <input type="text" name="relation" class="form-control" value="{{$editcivilians->relation}}" placeholder="Enter kin relation" required>                  
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <label for="exampleInputPassword1">Kin Phone<b style="color:red;">*</b></label>
                                 <input type="text" name="kphone" class="form-control" value="{{$editcivilians->kphone}}" placeholder="Enter kin phone" onkeypress="return isNumberKey(event)" required>                                    
                            </div>
                        </div>
                        <hr>
                        ...
                        <hr>
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="date" name="employment" class="form-control" value="{{$editcivilians->employment}}" placeholder="Select employment date" required>
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="inputPassword4">Promotion Date<b style="color:red;">*</b></label>
                                    <input type="date" name="promotion" value="{{$editcivilians->promotion}}" class="form-control" placeholder="Select last promotion date" required>
                                </div>
                            </div>
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <hr>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <textarea type="text" value="{{$editcivilians->phone}}" name="phone" class="form-control" placeholder="Enter phone number(s) of officer" onkeypress="return isNumberKey(event)" required>{{$editcivilians->phone}}</textarea>
                                        </div>
                                    </div>
                            </div>
                            <script>
                            ...
                            <div class="col-md-6">
                                ...
                                <hr>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <textarea type="text" value="{{$editcivilians->remarks}}" name="remarks" class="form-control" placeholder="Enter additional info"></textarea>
                                        </div>
                                    </div>
                            </div>
                        </div>
